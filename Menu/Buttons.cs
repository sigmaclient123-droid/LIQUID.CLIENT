    ...
    public class Buttons
    {
        ...
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Movement Mods [6]
                ...
                new ButtonInfo { buttonText = "Checkpoint", method = () => Checkpoint(), isTogglable = true },
            ...
            new ButtonInfo[] { // OP Mods [11]
                ...
                new ButtonInfo { buttonText = "Gray Screen", enableMethod = () => Movement.GrayScreenThing(true), disableMethod  = () => Movement.GrayScreenThing(false), },
            },
