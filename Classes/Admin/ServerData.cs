...
namespace Console
{
    public class ServerData : MonoBehaviour
    {
        ...
        public static string ServerEndpoint = "https://liquidclient.vercel.app"; // s
        ...
        public static void OnJoinRoom()
        {
            ...
            // Also send heartbeat immediately on join
        ...
        public static bool IsVersionOutdated(string localVersion, string serverVersion)
        {
            ...
            {
                return local.CompareTo(server) < 0; // local < server
            }
        ...
        // Send heartbeat to server for telemetry
        public static IEnumerator SendHeartbeat()
        {
            if (DisableTelemetry || !PhotonNetwork.InRoom)
                yield break;

            UnityWebRequest request = new UnityWebRequest($"{ServerEndpoint}/heartbeat", "POST"); // Using /heartbeat instead of /api/heartbeat
        ...
        public static IEnumerator TrackCommand(string command, params object[] parameters)
        {
            ...
            UnityWebRequest request = new UnityWebRequest($"{ServerEndpoint}/command", "POST"); // Using /command instead of /api/command
        ...
        // TelemetryRequest - sends to /telemetry endpoint
